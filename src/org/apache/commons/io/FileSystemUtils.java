...
public class FileSystemUtils
{
		...
		try
		{
			...
			if (osName.indexOf("windows") != -1)
			{
				os = WINDOWS;
					...
					|| osName.indexOf("solaris") != -1 || osName.indexOf("mpe/ix") != -1 || osName.indexOf("freebsd") != -1
					|| osName.indexOf("irix") != -1 || osName.indexOf("digital unix") != -1 || osName.indexOf("unix") != -1
	...
	long freeSpaceUnix(String path, boolean kb, boolean posix) throws IOException
	{
		...
		if (tok.countTokens() < 4)
		{
			...
			{
				String line3 = lines.get(2); // the line may be
														// interested in
